...
class NegativeHarmonyEditor : public AudioProcessorEditor, MidiKeyboardStateListener
{
public:
    explicit NegativeHarmonyEditor(NegativeHarmonyProcessor&, AudioProcessorValueTreeState&);
...
private:
    ...
    MidiKeyboardComponent midi_keyboard_ {
        midi_keyboard_state_,
        MidiKeyboardComponent::horizontalKeyboard
    };
    ToggleButton power_on_button_{"to negative harmony"};
    Slider tonic_note_no_slider_{
